...
D21.all.sites <- read.delim("~/Desktop/Research_projects_2015-2016/iCLIP/results_from_scripts/010418_Data_from_Nadia/091317_iCLIP_Dbp21_intersected_reads_xlinking_sites_filtered.txt", quote = "", as.is = T)
D21.site.gr <- GRanges(seqnames = Rle(D21.all.sites$chr), ranges = IRanges(start = D21.all.sites$D1_xlinking_site, end = D21.all.sites$D1_xlinking_site), strand = Rle(D21.all.sites$strand), id = D21.all.sites$id, seqlengths = yeast.length)
...
### 1.0    62.0   121.0   164.7   216.0   796.0 
orf.width <- width(orf.gr)
summary(orf.width) ### Median: 1371
### Min. 1st Qu.  Median   Mean   3rd Qu.  Max. 
###  78     858    1371    1714    2139   14730 
utr3.width <- width(utr3.gr)
summary(utr3.width) ### Median: 150
### Min. 1st Qu.  Median   Mean   3rd Qu.  Max.
### 4.0   104.0   150.0   188.4   232.2  1423.0 
...
write.table(D21.whole.mat, file = "~/Desktop/Research_projects_2015-2016/iCLIP/results_from_scripts/010418_Data_from_Nadia/010518_iCLIP_Dbp21_all_filtered_sites_in_bound_mRNAs_count_mat_100bins.txt", quote = F, sep = "\t")
write.table(D21.whole.prop.table, file = "~/Desktop/Research_projects_2015-2016/iCLIP/results_from_scripts/010418_Data_from_Nadia/010518_iCLIP_Dbp21_all_filtered_sites_in_bound_mRNA_prop_table_100bins.txt", quote = F, sep = "\t")
...
par(lwd = 2)
plot(0.5:99.5, apply(D21.whole.prop.table, 2, mean, na.rm=T), cex.lab = 1.2, cex.axis = 1.1, type="l", lwd=4, col="blue3", yaxt="n", ylim = c(0, 0.03), xaxt = "n", xlab = "Relative transcript positions", ylab = "Dbp2 occupancy", main = "iCLIP_D21, Dbp2-binding mRNAs, all sites")
