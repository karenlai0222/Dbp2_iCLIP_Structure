...
D23.all.sites <- read.delim("Dbp2iCLIP_sitesFromReproducedReads/060618_iCLIP_Dbp23_intersectedReads_allxlinkingSites.txt",
                            quote = "", as.is = T)
...
D23.whole.prop.table <- read.delim("~/Desktop/Research_projects_2015-2016/iCLIP/results_from_scripts/060618_Dbp2iCLIPdata_reprocessing/060718_iCLIP_Dbp23_all_FilteredSites_inBoundmRNA_propTable100bins.txt",
                                   as.is = T)
