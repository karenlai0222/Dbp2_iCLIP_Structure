...
D22.all.sites <- read.delim("060618_iCLIP_Dbp22_intersectedReads_allxlinkingSites.txt",
                            quote = "", as.is = T)
...
D22.whole.prop.table <- read.delim("060718_iCLIP_Dbp22_all_FilteredSites_inBoundmRNA_propTable100bins.txt",
                                   as.is = T)
par(lwd = 2)
